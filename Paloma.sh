...
echo '================================================='
echo -e "Ваше имя ноды: \e[1m\e[32m$NODENAME\e[0m"
echo -e "Ваше название кошелька: \e[1m\e[32m$WALLET\e[0m"
echo -e "Имя сети: \e[1m\e[32m$PALOMA_CHAIN_ID\e[0m"
echo -e "Ваш порт: \e[1m\e[32m$PALOMA_PORT\e[0m"
echo '================================================='
sleep 2
...
echo -e 'Проверка логов: \e[1m\e[32mjournalctl -u palomad -f -o cat\e[0m'
echo -e "Проверка статуса: \e[1m\e[32mcurl -s localhost:${PALOMA_PORT}657/status | jq .result.sync_info\e[0m"
